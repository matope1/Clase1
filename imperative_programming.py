...
'''
Una función que recibe un objeto inventario y lo pinta "bonito", para usuarios (al usuario no le importa el sku, 
sino que le importa qué nombre tiene el producto, su precio...)
